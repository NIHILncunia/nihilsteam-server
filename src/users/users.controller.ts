...
export class UsersController {
  ...
  @ApiOkResponse({ description: '성공', type: User, isArray: true, })
  @ApiOperation({
    summary: '모든 유저 조회',
  ...
  @UseGuards(JwtAuthGuard)
  @Patch(':id')
  async deleteUser(@Param('id') id: number, @Body() withdrawUserDTO: WithdrawUserDTO) {
    return this.usersService.deleteUser(id, withdrawUserDTO);
  }
}
